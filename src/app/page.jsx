...
export default function BirthdayApp() {
  ...
  const screens = [
    ...
    <SpecialMessages key="messages" onNext={() => setCurrentScreen(4)} />,
    <Letter key="letter" />,
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950/30 via-black to-purple-950/30 overflow-hidden relative">
      ...
      <motion.div
        ...
        className="fixed bottom-4 right-4 text-[13px] text-white/40 z-50 font-light">
        <a 
          href="https://instagram.com/kaarthikarora" 
          target="_blank" 
